...
public class Bid {
	...
	public Bid(Integer id, Integer productId, Integer bidAmount, Integer buyerId, String buyerName, String buyerPhone,
			String buyerEmail) {
		super();
		this.id = id;
	...
	public String toString() {
		return "Bid [id=" + id + ", productId=" + productId + ", bidAmount=" + bidAmount + ", buyerId=" + buyerId
