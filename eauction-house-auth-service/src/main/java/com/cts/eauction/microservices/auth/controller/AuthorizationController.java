...
public class AuthorizationController {
	...
	public @ResponseBody UserTokens registerUser(User user) throws UserAlreadyExistWithThisEmail {
	...
	public @ResponseBody UserTokens login(User user) throws InvalidLoginCredentialException {
		user = userService.registerUser(user);
