...
public class ProductCommand {
	...
	public ProductCommand(String productName, String shortDescription, String detailedDescription, String category,
			Integer startingPrice, Date bidEndDate, Integer sellerId) {
		super();
